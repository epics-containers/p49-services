...
# to work with the p49 IOCs and Services.
...
echo "Loading environment for p49 IOC Instances and Services ..."

#### SECTION 1. Environment variables ##########################################

export EC_CLI_BACKEND="K8S"
# the namespace to use for kubernetes deployments
export EC_TARGET=p49-beamline
# the git repo for this project
export EC_SERVICES_REPO=https://github.com/epics-containers/p49-services
...
kubectl config set-context --current --namespace=p49-beamline
